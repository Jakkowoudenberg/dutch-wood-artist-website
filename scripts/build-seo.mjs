...
for (const name of ['images', 'jakko-os', 'privacy.html', 'robots.txt', '_headers', '_redirects', 'manifest.json', 'googlef0d31f940bfa34d2.html']) await cp(resolve(root, name), resolve(out, name), { recursive: true });
